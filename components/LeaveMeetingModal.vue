...
const { leaveRoom } = getHmsInstance()
const customModal = {
	overlay: {
...
<template>
	<Button class="rounded-lg bg-rose-600 px-3 py-2 text-sm font-medium text-white hover:bg-rose-700"
		@click="isLeaveModalOpen = true" data-testid="leave-button">
		Leave
	</Button>
	<UModal v-model="isLeaveModalOpen" class="w-[90vw] max-w-[450px]" :ui="customModal" data-testid="leave-modal">
		<div class="relative rounded bg-white p-4 shadow-lg">
			...
			<div class="mt-4 flex justify-center gap-4">
				<UButton type="button" variant="ghost" color="gray" @click="isLeaveModalOpen = false"
